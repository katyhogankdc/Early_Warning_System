...
SUM(1) MEMBERSHIP,
SUM(CASE WHEN DESCRIPTION IN ('Absent','Absent Unexcused','Medical Unexcused') THEN 1 ELSE 0 END) UNEXCUSED_ABSENCES, --there is ap probably a better value to pull unexcused absences from so they don't need be hardcoded
