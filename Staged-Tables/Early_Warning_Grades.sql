IF OBJECT_ID('CUSTOM.CUSTOM_EARLY_WARNING_GRADES','U') IS NOT NULL
	DELETE FROM CUSTOM.CUSTOM_EARLY_WARNING_GRADES
...
IF (SELECT OBJECT_ID
	FROM sys.indexes 
	WHERE name='EW_GRADES' AND object_id = OBJECT_ID('CUSTOM.CUSTOM_EARLY_WARNING_GRADES')) IS NULL
