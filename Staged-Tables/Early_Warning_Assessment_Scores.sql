DROP TABLE CUSTOM.CUSTOM_EARLY_WARNING_ASSESSMENT_SCORES_MATH;
...
LEFT JOIN [custom].CUSTOM_EARLY_WARNING_TERMS TERMS ON RIGHT(SCHOOLYEAR4DIGIT,2)+9 = TERMS.YEARID AND TERMS.SEASON = TESTPERIOD AND CAST(SC.SYSTEMSCHOOLID AS INT) = TERMS.SCHOOLID 
...
DROP TABLE CUSTOM.CUSTOM_EARLY_WARNING_ASSESSMENT_SCORES_READING;
